...
public class employeeHomeController {
	...
	@FXML
	void handleEmployeesAction(ActionEvent event) {
		try {
			loadFXML("/FXML/EmployeeManagement.fxml");
		} catch (IOException e) {
			System.out.println(e.getMessage());
		}
	}
	...
	@FXML
	void handleComplaintAction(ActionEvent event) {
		try {
			loadFXML("/FXML/faultsAndComplaints.fxml");
		} catch (IOException e) {
			System.out.println(e.getMessage());
		}
	}
